...
var sessionStats = new Reef('#sessionStats', {
  ...
  template: function (props) {
    ...
    return `
      ...
      <div id="hr">
        <div class="statVal">${props.curHR}</div>
...
function characteristicValueChanged(e) {
  ...
  if (store.data.inSessionStats) store.data.curHR = result.heartRate
}
...
function stopSession() {
  ...
  store.data.inSessionStats = false
